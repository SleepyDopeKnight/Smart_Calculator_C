...
START_TEST(test_1) {
  char test[255] = "2*4*5*(6)";
  double res = terminal(test, 0);
  ck_assert_double_eq_tol(res, 240, 0.000001);
}
END_TEST

START_TEST(test_2) {
  char test[255] = "8*sin(6)";
  double res = terminal(test, 0);
...
START_TEST(test_10) {
  char test[255] = "15+75*1/3-42+3^3";
  double res = terminal(test, 0);
  ck_assert_double_eq_tol(res, 25, 0.000001);
}
END_TEST
...
START_TEST(test_11) {
  char test[255] = "asin(12*x)";
  double res = terminal(test, 0.05);
  ck_assert_double_eq_tol(res, 0.643501109, 0.000001);
}
END_TEST

START_TEST(test_12) {
  char test[255] = "acos(3*0.08)";
  double res = terminal(test, 0);
  ck_assert_double_eq_tol(res, 1.32843048, 0.000001);
}
END_TEST

START_TEST(test_13) {
  char test[255] = "atan(-8*x)";
  double res = terminal(test, 0.014);
  ck_assert_double_eq_tol(res, -0.111535184, 0.000001);
}
END_TEST

START_TEST(test_14) {
  char test[255] = "tan(-6*x)";
  double res = terminal(test, 2);
  ck_assert_double_eq_tol(res, 0.63585992866, 0.000001);
}
END_TEST

START_TEST(test_15) {
  char test[255] = "sqrt(4*x)";
  double res = terminal(test, 45);
  ck_assert_double_eq_tol(res, 13.416407865, 0.00001);
}
END_TEST

START_TEST(test_16) {
  char test[255] = "ln(10*x)";
  double res = terminal(test, 2);
